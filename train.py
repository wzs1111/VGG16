...
BATCH_SIZE = 128
learning_rate = 0.01
MAX_STEP = 5000   # it took me about one hour to complete the training.
IS_PRETRAIN = True
...
def train():
    ...
    with tf.name_scope('input'):
        tra_image_batch, tra_label_batch = read.read_cifar10(data_dir=data_dir,
                                                             is_train=True,
                                                             batch_size=BATCH_SIZE,
                                                             shuffle=True)
        val_image_batch, val_label_batch = read.read_cifar10(data_dir=data_dir,
                                                             is_train=False,
                                                             batch_size=BATCH_SIZE,
                                                             shuffle=False)
...
def evaluate():
    with tf.Graph().as_default():
        ...
        images, labels = read.read_cifar10(data_dir=data_dir,
                                           is_train=False,
                                           batch_size=BATCH_SIZE,
                                           shuffle=False)
